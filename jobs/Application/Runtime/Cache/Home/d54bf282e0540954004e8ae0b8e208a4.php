...
<a href="<?php echo U('Home/Index/passwordedit?id='.$list[0]['id']);?>" class="btn btn-success">修改密码</a>
	<a href="<?php echo U('Home/Index/clear');?>" class="btn btn-primary">退出</a><br>
<label>筛选：</label><br>
	<form action="<?php echo U('Home/Index/tstudent');?>" method="post" name="creator">
	...
	<form action="<?php echo U('Home/Index/tstudent');?>" method="post">
	...
	<table class="table table-hover" style="background:white;">
		...
		<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
				...
				<td>
				<a href="<?php echo U('Home/Index/showresume?id='.$vo['id']);?>">简历</a>
				<?php if($vo[0]['timeout'] == 1): ?><span class="glyphicon glyphicon-asterisk"> </span>
					<a href="<?php echo U('Home/Index/invitehistory?id='.$vo['id']);?>" style="color:red;">受邀历史</a>
				</td>
				<?php else: ?>
					<a href="<?php echo U('Home/Index/invitehistory?id='.$vo['id']);?>">受邀历史</a></td><?php endif; ?>
